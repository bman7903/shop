...
def HEAD():
   ...
   h  = '''\
     <html> <head> Loading...
     <link rel="stylesheet" type="text/css" href="css/main''' + c + '''.css" />
...
def monkey( proc, img ):
  ...
  def bad():
     M = '''\
       <div id="content-wrapper"><div id="content"> 
       <br><br><center><label>
          YOU HAVE BEEN A VERY BAD MONKEY!</label><br><br>
          <div><pre><img src="''' + img + '''"></pre></div>
       <br><br></center></div></div>'''
     
     H = str( HEAD() )
     T = str( TAIL('BAD-MONKEY!') )
     HTML = str( H + '\n' + M + '\n' + T )
     return HTML
  M = eval( proc )
  return M()
...
def lots( oid, User, item, gory, subc, desc, img1, img2, img3, price, ship, lts, pcs, info, ouid ):
  def mid():
     h = ''' \
       <div id="content-wrapper"><div id="content"><br><br><b>
          <div><label><b>''' + item + '''</b><pre>
          <div><u><b>Description</u>:</b> ''' + desc + '''</div></pre><br>
          <div><center>  <a href=''' + img1 + ''' ><img src=''' + img1 + ''' width="156" height="156y"></a>&nbsp&nbsp&nbsp&nbsp
           <a href=''' + img2 + '''><img src=''' + img2 + ''' width="156" height="156"></a>&nbsp&nbsp&nbsp&nbsp
           <a href=''' + img3 + '''><img src=''' + img3 + ''' width="156" height="156"></a></center></div><br>
          ...
          <pre><div><form action="/" method="post" style="display:inline"><input type="hidden" name="kart" value=''' + oid + '''>  <input type="submit" value="Back">  <input type="submit" value="Add-2-Kart">&nbsp&nbsp</form><form action="/purchase" method="post" style="display:inline"><input type="submit" value="Purchase">
          </form></div></pre>
       </div></div> '''
     return h
  ...
  def landing():
     ...
     <div id="content-wrapper"><div id="content"><br><br><b>
       ...
       <h1><div class="box b"><tr>
            <td style="background-color: green;   padding: 55px;"><form action="home-add" method="post"><input type="submit" value="Add" name="addz"><input type="submit" value="Del" name="delete">
</td><input type="hidden" name="uzer" value="''' + ustr + '''"></td>
  ...
  def add():
     M  = '''\
       <div id="content-wrapper">       <div id="content">
         ...
         <br><input type="submit" value="Submit"></form></div></pre>
       </div></div> '''
     return M

  def edit():
     for e in str( lots ).split(' , "'):
       e = str( e )
       if 'item' in e:
          item  = str( e.split('" : "')[-1] )
       if 'gory' in e:
     ...
     M  = '''\
       <div id="content-wrapper">       <div id="content">
          ...
          <form action="/pre-add" method="post"><pre>
          <input type="hidden" name="uzer" value="''' + ustr + '''">
          <div>        item:    <input type="text" name="item" value="''' + item + '''" style="width: 200px; height: 25px;">
           <br>    category:    <input type="text" name="cat" value="''' + gory + '''" style="width: 200px; height: 25px;">
           <br>sub-Category:    <input type="text" name="sub-cat" value="''' + subc + '''" style="width: 200px; height: 25px;"> *
           <br> Description:    <input type="text" name="desc" value="''' + desc + '''" style="width: 200px; height: 25px;">
           <br>   Price USD:    <input type="text" name="price" value="''' + price + '''" style="width: 200px; height: 25px;">
           <br>    Shipping:    <input type="text" name="shipping" value="''' + ship + '''" style="width: 200px; height: 25px;"> *
           <br> Image 1 URL:    <input type="text" name="image1" value="''' + img1 + '''" style="width: 200px; height: 25px;">
           <br> Image 2 URL:    <input type="text" name="image2" value="''' + img2 + '''" style="width: 200px; height: 25px;"> *
           <br> Image 3 URL:    <input type="text" name="image3" value="''' + img3 + '''" style="width: 200px; height: 25px;"> *
           <br>  Pieces Per:    <input type="text" name="pieces" value="''' + pcs + '''" style="width: 200px; height: 25px;">
           <br>  Total Lots:    <input type="text" name="lots" value="''' + lts + '''" style="width: 200px; height: 25px;"> *
           <br>        Info:    <input type="text" name="more" value="''' + info + '''" style="width: 200px; height: 25px;"></label> *
         <br><input type="submit" value="Submit"></div></form><form action="/home-del" method="post"><input type="submit" value="Submit"></form></pre>
       </div></div> '''
     M = str( M + ' ' + str( lots ) )
     return M

  def remove():     
     html =  str( 'Good Job Remove, removing ' + str(lots) )
     return html
  def dupe():
     html = 'Good Job Dupe!'
     return html
